...
function App() {
  ...
  const [postUrl, setPostUrl] = useState("http://jjayodesktop.kro.kr:8080/api/timetables/memo");
  ...
  const getTables = async() => {
    const timetable = await fetch('http://jjayodesktop.kro.kr:8080/api/timetables' + location.search)
  ...
  const getMeals = async() => {
    const meals = await fetch('http://jjayodesktop.kro.kr:8080/api/meals' + location.search)
  ...
  const handleSubmit = (e) => {
    ...
    // POST 요청 보내기 (예: fetch)
    fetch('http://jjayodesktop.kro.kr:8080/api/timetables/memo', {
      method: 'POST',
      headers: {
