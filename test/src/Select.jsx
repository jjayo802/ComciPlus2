...
function Select() {
    ...
    const loadSchoolResults = async(schoolName) => {
        ...
        const results = await fetch('http://jjayodesktop.kro.kr:8080/api/schools?' + searchParams.toString())
    ...
    const loadSchoolClasses = async(grade) => {
        ...
        const results = await fetch('http://jjayodesktop.kro.kr:8080/api/classes?' + searchParams.toString())
            .then((results) => results.json());
